...
const heroGlob = import.meta.glob<string>("../../../../assets/events/2025/cgs/AlexKidd/hero*.*", { eager: true, as: "url" });
const hero = Object.values(heroGlob);
const iconGlob = import.meta.glob<string>("../../../../assets/events/2025/cgs/AlexKidd/icon.*", { eager: true, as: "url" });
const icon = Object.values(iconGlob);
const logoGlob = import.meta.glob<string>("../../../../assets/events/2025/cgs/AlexKidd/logo.*", { eager: true, as: "url" });
